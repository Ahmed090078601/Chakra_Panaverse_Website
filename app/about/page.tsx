...
<Button colorScheme='teal' mt={5}>More Info</Button>
</Box>
</Flex>
    </Container>
    </RevealWrapper>
  ...
  <Box>
  <RevealWrapper origin='right' delay={200} duration={3000} distance='500px' reset={true}>
  <Container maxW={1400}>
<Flex my='50px' px={{lg:'50px',base:'20px'}} gap='30px' display={{lg:'flex',base:'grid'}}>
...
<Box flexBasis={'50%'}>
<Image mx='auto' src='/logo5.webp' alt='President'/>
</Box>
</Flex>
    </Container>
    </RevealWrapper>
...
<Flex my='50px' px={{lg:'50px',base:'20px'}} gap='30px' display={{lg:'flex',base:'grid'}}>
<Box flexBasis={'50%'}>
<Image mx='auto' src='/Zia.webp' alt='President'/>
</Box>
<Box flexBasis='50%'>
